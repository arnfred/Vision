...
\begin{figure}[h]
	\makebox[\textwidth][c]{%
		\begin{minipage}[t]{0.75\textwidth}
			\centering
			\includegraphics[width=\textwidth]{img/sigma_overview}
			\caption{Variation of Sigma}
			\label{fig:normal}
		\end{minipage}%
		\qquad
		\begin{minipage}[t]{0.75\textwidth}
			\centering
			\includegraphics[width=\textwidth]{img/normal_zoom}
			\caption{Four iterations for sigma of 0.05 together with  
			the residual norm}
			\label{fig:res_error}
		\end{minipage}%
	}%
...
\begin{figure}[h!]
	\makebox[\textwidth][c]{%
		\begin{minipage}[t]{0.75\textwidth}
			...
			\caption{Variation of Tolerance at sigma = 0.1}
			\label{fig:tolerance}
		\end{minipage}%
		\qquad
		\begin{minipage}[t]{0.75\textwidth}
			...
			\caption{Variation of Tolerance at sigma = 0.05}
...
\begin{figure}[h]
	\makebox[\textwidth][c]{%
		\begin{minipage}[t]{0.75\textwidth}
			...
			\caption{Variation of Scales at sigma = 0.1}
			\label{fig:scaling}
		\end{minipage}%
		\qquad
		\begin{minipage}[t]{0.75\textwidth}
