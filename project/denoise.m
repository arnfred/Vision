...
function [u u_mu iter iter_mu burn_iter psnr psnr_mu r r_mu] = denoise(sigma, scaling, remove_scales, max_burn, max_iter)
	...
	% Translate sigma to image dependent sigma
	sigma											= sigma * 255
	...
	[u_b u_mu_b i_b i_mu_b p_b p_mu_b r_b r_mu_b]	= gibbs.sample(mrf, u, B, sigma, max_burn, psnr_fun, border);
